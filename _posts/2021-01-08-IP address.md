...
#### IPv4
IPv4는 32비트 길이의 식별자로 8비트 단위 4부분으로 10진수로 표시되며 0.0.0.0 ~ 255.255.255.255까지의 범위를 갖는다. 주소 자리는 옥테드 '.'로 구분한다.<br/>
...
#### IPv6
IPv6는 128비트 길이의 식별자로 16비트 단위 8부분으로 16진수로 표현된다. 주소 자리는 ':'로 구분한다.<br/>
